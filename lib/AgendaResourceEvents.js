      ...
      resourceEvents.headerItems.forEach(function (item) {
        ...
        if (start === headerStart && end === headerEnd) {
          item.events.forEach(function (evt) {
            ...
            var eventItem = _react2.default.createElement(_AgendaEventItem2.default, _extends({}, _this2.props, { key: evt.eventItem.id, eventItem: evt.eventItem, isStart: isStart, isEnd: isEnd }));
