...
class Scheduler extends Component {
  ...
  render() {
    ...
    if (showAgenda) {
      ...
      const { slotClickedFunc, slotItemTemplateResolver, toggleExpandFunc } = this.props;
        ...
        <tr>
          <td>
            <div className="scheduler-view" style={{ width: schedulerContainerWidth, verticalAlign: 'top' }}>
              ...
              >
                {/* @todo: borders? lol */}
                <div style={{ width: schedulerWidth + resourceTableWidth - 1, height: contentHeight }}>
                  <div className="scheduler-content">
                    <table className="scheduler-content-table" style={{ width: '100%' }}>
