  ...
  _createClass(ResourceEvents, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          resourceTableWidth = _props2.resourceTableWidth,
          resourceView = _props2.resourceView,
          groupOnly = _props2.groupOnly;
        ...
        if (headerItem.count > 0 || headerItem.summary != undefined) {
          ...
          headerItem.events.forEach(function (evt, idx) {
            if (idx < renderEventsMaxIndex && evt !== undefined && evt.render) {
              ...
              var left = index * cellWidth + (index > 0 ? 2 : 3);
              var width = evt.span * cellWidth - (index > 0 ? 5 : 6) > 0 ? evt.span * cellWidth - (index > 0 ? 5 : 6) : 0;
          ...
          if (headerItem.addMore > 0) {
            var left = index * cellWidth + (index > 0 ? 2 : 3);
            var width = cellWidth - (index > 0 ? 5 : 6);
          ...
          if (headerItem.summary != undefined) {
            ...
            var _width = cellWidth - (index > 0 ? 5 : 6);
            var key = resourceEvents.slotId + '_' + headerItem.time;
            var summary = _react2.default.createElement(_Summary2.default, { key: key, schedulerData: schedulerData, summary: headerItem.summary, left: _left, width: _width, top: _top });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { style: { width: groupOnly ? 'auto' : resourceTableWidth } },
              resourceView
            ),
            _react2.default.createElement(
              'div',
              ...
              connectDropTarget(_react2.default.createElement(
                'div',
                { ref: this.eventContainerRef, style: { display: 'flex', flexDirection: 'row', flex: 1 }, className: 'event-container' },
                eventList
              ))
            )
          )
