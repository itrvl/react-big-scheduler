...
var AgendaEventItem = (_temp = _class = function (_Component) {
  ...
  _createClass(AgendaEventItem, [{
    ...
    value: function render() {
      ...
      var content = _react2.default.createElement(_EventItemPopover2.default, _extends({}, this.props, { title: eventItem.title, startTime: eventItem.start, endTime: eventItem.end, statusColor: bgColor }));
      ...
      return config.eventItemPopoverEnabled ? _react2.default.createElement(
        _popover2.default,
        { placement: 'bottomLeft', content: content, trigger: 'hover', mouseEnterDelay: 0 },
        _react2.default.createElement(
          'a',
          {
            className: 'day-event',
